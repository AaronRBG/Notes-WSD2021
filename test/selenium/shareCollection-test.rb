...
class Share_Collections < Test::Unit::TestCase
  ...
  def share_collection
    ...
    @driver.find_element(:name, "notecollection[name]").send_keys "La colleccion de Diego"
    sleep 0.3
    ...
    fila=@driver.find_elements(:xpath => "//table[@id='table-add']/tbody/tr")[4]
